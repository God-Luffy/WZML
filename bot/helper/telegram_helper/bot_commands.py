...
class _BotCommands:
    def __init__(self):
        ...
        self.LeechCommand = [f'download{CMD_SUFFIX}', f'down{CMD_SUFFIX}']
        self.QbLeechCommand = [f'megnet{CMD_SUFFIX}', f'mg{CMD_SUFFIX}']
        self.YtdlLeechCommand = [f'ytdldownload{CMD_SUFFIX}', f'ytdown{CMD_SUFFIX}']
        if config_dict['SHOW_EXTRA_CMDS']:
            ...
            self.QbMirrorCommand.extend([f'megnetunzipmirror{CMD_SUFFIX}', f'qbm{CMD_SUFFIX}', f'qbzipmirror{CMD_SUFFIX}', f'qzm{CMD_SUFFIX}'])
            self.YtdlCommand.extend([f'ytdlzip{CMD_SUFFIX}', f'yz{CMD_SUFFIX}'])
            self.LeechCommand.extend([f'unzip{CMD_SUFFIX}', f'uzip{CMD_SUFFIX}', f'zipleech{CMD_SUFFIX}', f'zl{CMD_SUFFIX}'])
            self.QbLeechCommand.extend([f'qbunzipleech{CMD_SUFFIX}', f'quzl{CMD_SUFFIX}', f'qbzipleech{CMD_SUFFIX}', f'qzl{CMD_SUFFIX}'])
            self.YtdlLeechCommand.extend([f'zipdownload{CMD_SUFFIX}', f'zipdown{CMD_SUFFIX}'])
        ...
        self.LogCommand = f'logs{CMD_SUFFIX}'
        ...
        self.GDCleanCommand = [f'driveclean{CMD_SUFFIX}', f'dclean{CMD_SUFFIX}']
